...
<div class="container-fluid ">
  <div class="row align-items-start">
    ...
    <a href="login.php"><button type="button" class="btn btn-outline-primary" style="margin-top: 20px;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
